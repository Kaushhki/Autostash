...
SECRET_KEY = 'django-insecure-change-this-in-production-CHANGE-ME'
...
# Dev-only: allow the standalone HTML dashboard (opened as a local file, or
# served from anywhere) to call this API directly from the browser.
# Tighten this to CORS_ALLOWED_ORIGINS = [...] before deploying anywhere real.
